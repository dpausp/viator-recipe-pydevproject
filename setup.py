...
name = "viator.recipe.pydevproject"
version = '0.2.dev0'
...
setup(
    ...
    author="Marcio Mazza / Tobias Stenzel",
    author_email="marciomazza@gmail.com Tobi.Stenzel@gmx.de",
    url='UNKNOWN',
    license='GPL',
    packages=find_packages(exclude=['ez_setup']),
    namespace_packages=['viator', 'viator.recipe'],
    ...
    test_suite='viator.recipe.pydevproject.tests.test_docs.test_suite',
